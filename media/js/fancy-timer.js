...
(function (factory) {
    ...
    var FancyTimer = /** @class */ (function () {
        function FancyTimer(containerEl, options) {
			...
			// Conseilgouz : add lang
			var lang = options.lang;
			if (lang && options.showDays > 0) {
				if (!captions) captions = {};
				captions.seconds = dictionary[lang].sec,
				captions.minutes = dictionary[lang].min,
				captions.hours = dictionary[lang].hours,
				captions.days = dictionary[lang].days;
			}
        ...
        FancyTimer.prototype.updateOptions = function (_a) {
            var value = _a.value, direction = _a.direction, warn = _a.warn, reverseAnimation = _a.reverseAnimation, onFinish = _a.onFinish, onWarning = _a.onWarning,max = _a.max,lang = _a.lang;
        ...
        FancyTimer.prototype.tick = function () {
            if (this.direction) {
				...
				if ( ((this.direction == 1) && (this.max > 0) && (value > this.max)) || (value < 0) ) {
                    this.stop();
